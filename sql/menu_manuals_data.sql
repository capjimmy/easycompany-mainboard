-- 메뉴별 매뉴얼 데이터 일괄 등록 (v1.3.0)
-- company_id: a0000000-0000-0000-0000-000000000001
-- 전체 프로세스 + 각 메뉴별 상세 매뉴얼

-- 기존 매뉴얼 삭제 후 재등록
DELETE FROM menu_manuals WHERE company_id = 'a0000000-0000-0000-0000-000000000001';

-- =====================================================
-- 전체 프로세스 매뉴얼 (대시보드에 포함)
-- =====================================================

INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'dashboard', '전체 업무 프로세스 및 대시보드',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
...
INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'project-status', '프로젝트 현황 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
...
INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'search', '통합검색 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
...
INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'ai-search', 'AI 검색 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
...
INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'quote-list', '견적관리 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
...
INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'contract-list', '계약관리 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
...
<h3>문서 출력 (3종)</h3>
<ul>
<li><strong>계약서</strong> / <strong>공문</strong> / <strong>용역비산출</strong></li>
</ul>
...
INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'monthly', '월별현황 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
...
INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'history', '계약변경이력 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
...
INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'subcontract', '외주관리 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
...
INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'client-list', '거래처관리 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
...
INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'receivables', '미수금관리 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
...
<strong>페이지 진입 시 자동 동기화:</strong> 잔금이 있는 모든 계약에서 미수금이 자동으로 생성됩니다.
수동으로 "계약 동기화" 버튼을 눌러 추가 동기화도 가능합니다.
</div>
...
INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'billing', '청구/입금 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
...
INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'payables', '미지급금관리 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
...
<h3>통계 카드</h3>
<ul>
<li><strong>총 미지급금</strong> / <strong>이번달 지급예정</strong> / <strong>연체금액</strong></li>
</ul>

<h3>상태</h3>
<ul>
<li>미지급 → 부분지급 → 완료 / 연체</li>
</ul>
</div>');

INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'deposits', '보증금관리 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
...
INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'tax-invoices', '세금계산서 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
...
INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'expenses', '경비정산 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
...
INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'provisional', '가수금관리 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
...
INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'leave', '연차 신청 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
...
INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'leave-admin', '연차 승인관리 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
...
INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'email-approvals', '메일 승인 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
...
INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'certificates', '증명서 발급 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
...
INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'calendar-contract', '계약 캘린더 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
...
INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'calendar-hr', '인사 캘린더 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
...
INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'calendar-space', '공간 캘린더 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
...
INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'project-dashboard', '프로젝트 현황 대시보드 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
<h2 style="color: #1890ff; border-bottom: 2px solid #1890ff; padding-bottom: 8px;">프로젝트 현황</h2>
...
INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'project-board', '프로젝트 보드 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
<h2 style="color: #1890ff; border-bottom: 2px solid #1890ff; padding-bottom: 8px;">프로젝트 보드 (칸반)</h2>
<p>칸반(Kanban) 보드 형태로 업무를 관리합니다.</p>
<h3>보드 구성</h3>
<ul>
<li><strong>할 일</strong> → <strong>진행 중</strong> → <strong>완료</strong></li>
</ul>
<h3>사용 방법</h3>
<ol>
...
INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'project-timeline', '일정관리 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
...
INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'messenger', '사내 메신저 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
...
INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'user-manage', '사용자관리 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
...
INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'department-manage', '부서관리 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
...
INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'permission-manage', '권한설정 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
...
INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'company-manage', '회사관리 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
...
INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'settings', '설정 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
...
INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'price-settings', '단가 설정 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
...
INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'doc-templates', '문서 템플릿 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
...
INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'backup', '백업관리 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
...
INSERT INTO menu_manuals (company_id, menu_key, title, content) VALUES
('a0000000-0000-0000-0000-000000000001', 'manuals', '매뉴얼 관리 매뉴얼',
'<div style="padding: 20px; font-family: ''Malgun Gothic'', sans-serif; line-height: 1.9; color: #333;">
